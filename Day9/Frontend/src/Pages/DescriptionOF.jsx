...
import ProductDataOF from './ProductDataOF';
const DescriptionPE = () => {
    const nav=useNavigate('');
  const [cardData, setCardData] = useState(ProductDataOF);
  ...
  return (
    ...
    <img src='https://cdn.modernbazaar.online/assets/uploads/category/compress/1fe6bf704dac5dfe6c2b8d2c50cb321d.jpg' className='img-fluid mt-2 rounded float-start' style={{ width: '1250px', height: '370px' ,marginLeft:'7%'}}/>
    </div>
