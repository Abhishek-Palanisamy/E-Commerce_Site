...
const DescriptionAmul = () => {
    const nav=useNavigate('');
  const [cardData, setCardData] = useState(ProductDataAmul);
  ...
  return (
    ...
    <img src='https://th.bing.com/th/id/R.e85eb1ec162190fff6de426d530fe978?rik=jGPObWL7HcFD6A&riu=http%3a%2f%2fbd-idc.com%2fimages%2fpagebuilder%2four-partners%2fbanner_amul.jpg&ehk=ygTJjHvO6jE6hzwjpRiH0KhAThevjejoHGyNv2wqs08%3d&risl=&pid=ImgRaw&r=0' className='img-fluid mt-2 rounded float-start' />
    </div>
...
export default DescriptionAmul