...
const Description = () => {
  ...
  return (
    ...
    <img src='https://scontent.fixm4-3.fna.fbcdn.net/v/t39.30808-6/309118355_163616462995668_1754555741655133589_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=783fdb&_nc_ohc=Awj0V-sEM7EAX-vdf6H&_nc_ht=scontent.fixm4-3.fna&oh=00_AfDlRqixitM5B1u0R9Ff8JMerEfvnAu76PrmzdjPPYt8-A&oe=658DD2F3' className='img-fluid mt-2 rounded float-start' style={{ width: '1250px', height: '370px' ,marginLeft:'7%'}}/>
    </div>
