...
import getPEById from './getPEById'
...
const PECart = () => {
  ...
  const peDetails = getPEById(PEId);

  if (!peDetails) {
    return <div>pe not found</div>;
  }
  ...
  useEffect(() => {
    ...
    if (peDetails.images && peDetails.images.length > 0) {
      setImages(peDetails.images);
    }
  }, [peDetails]);
          ...
          <Col className='cart1-enclosure d-flex '>
            ...
            <Row className='cart-content'>
              <Col className='ml-1'>
                ...
                <p className='name'>{peDetails.name}</p>
                <p className='ratings'>
                ...
                <p className='price'>Price: Rs.{peDetails.price}</p>
