...
import ProductDataPE from './ProductDataPE'
...
const DescriptionPE = () => {
  ...
  const [cardData, setCardData] = useState(ProductDataPE);
  ...
  return (
    ...
    <img src='https://martoo.com/wp-content/uploads/2023/07/Artboard-1-copy-11-1.jpg' className='img-fluid mt-2 rounded float-start' style={{ width: '1250px', height: '370px' ,marginLeft:'7%'}}/>
    </div>
