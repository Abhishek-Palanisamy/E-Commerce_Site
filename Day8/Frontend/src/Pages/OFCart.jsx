...
import getOFById from './getOFById';
const OFCart = () => {
  const { id } = useParams();
  const OFId = parseInt(id, 10);
  const ofDetails = getOFById(OFId);

  if (!ofDetails) {
    return <div>of not found</div>;
  }
  ...
  useEffect(() => {
    ...
    if (ofDetails.images && ofDetails.images.length > 0) {
      setImages(ofDetails.images);
    }
  }, [ofDetails]);
      ...
      <Container fluid>
        <Row>
          <Col className='cart-header'>
            ...
            <a href='/descof' className='header-bold text-decoration-none'>Dairy Poultry</a>
            <a href='/descof' className='header-bold text-decoration-none'>Oils Foodgrains Spices</a>
          ...
          <Col className='cart1-enclosure d-flex '>
            ...
            <Row className='cart-content'>
              <Col className='ml-1'>
                ...
                <p className='name'>{ofDetails.name}</p>
                <p className='ratings'>
                ...
                <p className='price'>Price: Rs.{ofDetails.price}</p>
