    ...
    <>
      <Container fluid className='footer-container text-decoration-none'>
        <Row className='footer-enclosure d-flex '>
          {/* Contact Us */}
          <Col md={3} className='footer-social_links '>
          ...
          {/* Information */}
          <Col md={3} className='footer-social_links text-decoration-none'>
          ...
          {/* Help */}
          <Col md={2} className='footer-social_links pb-1'>
          ...
          {/* Popular Categories */}
          <Col md={2} className='footer-social_links'>
            <h5 className='headercontact  pt-1'>Popular Categories</h5>
            <a href='#' className='text-decoration-none'>Vegetables</a>
            <a href='#' className='text-decoration-none'>Fruits</a>
            <a href='#' className='text-decoration-none'>Dairy</a>
            <a href='#' className='text-decoration-none'>Rice and Wheat</a>
          </Col>

          {/* Popular Brands */}
          <Col md={2} className='footer-social_links pb-1'>
            <h5 className='headercontact  pt-1'>Popular Brands</h5>
            <a href='#' className='fn text-decoration-none'>Amul</a>
        ...
        <Row className='footer-links d-flex justify-content-between'>
          <Col md={2}><a href='#' className='text-decoration-none text-white'>FAQ</a></Col>
          <Col md={2}><a href='#' className='text-decoration-none text-white'>Privacy Policy</a></Col>
          <Col md={2}><a href='#' className='text-decoration-none text-white'>Terms and Conditions</a></Col>
          <Col md={2}><a href='#' className='text-decoration-none text-white'>Contact Us</a></Col>
          <Col md={2}><a href='#' className='text-decoration-none text-white'>About Us</a></Col>
          <Col md={2}><a href='#' className='text-decoration-none text-white'>Shipping Policy</a></Col>
        </Row>
