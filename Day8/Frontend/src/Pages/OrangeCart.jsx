      ...
      <Container fluid>
        <Row>
          <Col className='cart-header'>
            <a href='#' className='header-bold text-decoration-none'>Fruits</a>
            <a href='#' className='header-bold text-decoration-none'>Vegetables</a>
            <a href='#' className='header-bold text-decoration-none'>Dairy Poultry</a>
